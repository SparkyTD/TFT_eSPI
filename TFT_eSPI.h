...
***************************************************************************************/
#define TFT_RGB_COLOR(b, g, r) (((r) & 0xF8) << 8) | (((g) & 0xFC) << 3) | ((b) >> 3)
#define TFT_BLACK       TFT_RGB_COLOR(  0,   0,   0)
#define TFT_NAVY        TFT_RGB_COLOR(  0,   0, 128)
#define TFT_DARKGREEN   TFT_RGB_COLOR(  0, 128,   0)
#define TFT_DARKCYAN    TFT_RGB_COLOR(  0, 128, 128)
#define TFT_MAROON      TFT_RGB_COLOR(128,   0,   0)
#define TFT_PURPLE      TFT_RGB_COLOR(128,   0, 128)
#define TFT_OLIVE       TFT_RGB_COLOR(128, 128,   0)
#define TFT_LIGHTGREY   TFT_RGB_COLOR(211, 211, 211)
#define TFT_DARKGREY    TFT_RGB_COLOR(128, 128, 128)
#define TFT_BLUE        TFT_RGB_COLOR(  0,   0, 255)
#define TFT_GREEN       TFT_RGB_COLOR(  0, 255,   0)
#define TFT_CYAN        TFT_RGB_COLOR(  0, 255, 255)
#define TFT_RED         TFT_RGB_COLOR(255,   0,   0)
#define TFT_MAGENTA     TFT_RGB_COLOR(255,   0, 255)
#define TFT_YELLOW      TFT_RGB_COLOR(255, 255,   0)
#define TFT_WHITE       TFT_RGB_COLOR(255, 255, 255)
#define TFT_ORANGE      TFT_RGB_COLOR(255, 180,   0)
#define TFT_GREENYELLOW TFT_RGB_COLOR(180, 255,   0)
#define TFT_PINK        TFT_RGB_COLOR(255, 192, 203)
#define TFT_BROWN       TFT_RGB_COLOR(150,  75,   0)
#define TFT_GOLD        TFT_RGB_COLOR(255, 215,   0)
#define TFT_SILVER      TFT_RGB_COLOR(192, 192, 192)
